/**
 * port-rubocop-cops-v2 — generic RuboCop cop porting workflow
 *
 * Usage:
 *   Workflow({ name: "port-rubocop-cops-v2" })
 *     → auto-fetches bd ready --label=cop -n 10
 *
 *   Workflow({ name: "port-rubocop-cops-v2", args: ["murphy-ipxn", "murphy-ttzm", "murphy-fgcu"] })
 *     → processes the specified issues only
 *
 *   Workflow({ name: "port-rubocop-cops-v2", args: { n: 6 } })
 *     → auto-fetches top N ready cop issues
 */

export const meta = {
  name: 'port-rubocop-cops-v2',
