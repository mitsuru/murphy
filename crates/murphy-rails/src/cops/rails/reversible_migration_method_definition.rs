...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/ReversibleMigrationMethodDefinition";
pub(crate) const MESSAGE_BYTES: &[u8] =
    b"Migrations must contain either a `change` method, or both an `up` and a `down` method.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 6] = [
        b"reversible_migration_method_definition",
        b"ReversibleMigrationMethodDefinition",
        b"reversible",
        b"migration",
        b"method",
        b"definition",
