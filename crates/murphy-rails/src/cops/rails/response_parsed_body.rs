...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/ResponseParsedBody";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Prefer `response.parsed_body`.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 4] = [b"parse", b"HTML", b"HTML4", b"HTML5"];
