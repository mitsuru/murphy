...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/EnumSyntax";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Enum defined with keyword arguments in `%<enum>s` enum declaration. Use positional arguments instead.";
