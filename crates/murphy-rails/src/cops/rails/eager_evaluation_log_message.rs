...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/EagerEvaluationLogMessage";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Pass a block to `Rails.logger.debug`.";
