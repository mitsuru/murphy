...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/RedundantActiveRecordAllMethod";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Redundant `all` detected.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 3] = [b".all.", b".all(", b"redundant_active_record_all_method"];
