...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/ApplicationMailer";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Mailers should subclass `ApplicationMailer`.";
