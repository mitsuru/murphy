...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/CompactBlank";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Use `%<preferred_method>s` instead.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 5] = [b"reject", b"delete_if", b"select", b"filter", b"keep_if"];
