...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/ThreeStateBooleanColumn";
pub(crate) const MESSAGE_BYTES: &[u8] =
    b"Boolean columns should always have a default value and a `NOT NULL` constraint.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 3] = [b"add_column", b"column", b"boolean"];
