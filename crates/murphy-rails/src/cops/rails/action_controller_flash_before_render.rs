...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/ActionControllerFlashBeforeRender";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Use `flash.now` before `render`.";
