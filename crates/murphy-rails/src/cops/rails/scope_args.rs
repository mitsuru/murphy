...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/ScopeArgs";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Use `lambda`/`proc` instead of a plain method call.";
