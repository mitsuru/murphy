...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/MailerName";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Mailer should end with `Mailer` suffix.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 4] = [b"mailer_name", b"MailerName", b"mailer", b"name"];
