...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/Exit";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Do not use `%<current>s` in Rails applications.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 3] = [b"exit", b"exit!", b"abort"];
