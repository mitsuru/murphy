...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/AttributeDefaultBlockValue";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Pass method in a block to `:default` option.";
