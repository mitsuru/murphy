...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/StripHeredoc";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Use squiggly heredoc (`<<~`) instead of `strip_heredoc`.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 1] = [b"strip_heredoc"];
