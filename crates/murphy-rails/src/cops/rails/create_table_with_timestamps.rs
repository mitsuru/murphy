...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/CreateTableWithTimestamps";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Add timestamps when creating a new table.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 1] = [b"create_table"];
