...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/HelperInstanceVariable";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Do not use instance variables in helpers.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 5] = [
        b"helper_instance_variable",
        b"HelperInstanceVariable",
        b"helper",
        b"instance",
        b"variable",
    ];
