...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/RedundantPresenceValidationOnBelongsTo";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Remove explicit presence validation for %<association>s.";
