...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/I18nLazyLookup";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Use %<style>s lookup for the text used in controllers.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 4] = [b"translate(\".", b"translate('.", b"t(\".", b"t('."];
