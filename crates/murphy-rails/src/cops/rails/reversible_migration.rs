...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/ReversibleMigration";
pub(crate) const MESSAGE_BYTES: &[u8] = b"%<action>s is not reversible.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 4] = [
        b"reversible_migration",
        b"ReversibleMigration",
        b"reversible",
        b"migration",
    ];
