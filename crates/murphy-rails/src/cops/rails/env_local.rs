...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/EnvLocal";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Use `Rails.env.local?` instead.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 4] = [b"env_local", b"EnvLocal", b"env", b"local"];
