...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/UnknownEnv";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Unknown environment `%<name>s`.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 4] = [b"unknown_env", b"UnknownEnv", b"unknown", b"env"];
