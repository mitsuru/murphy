...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/DurationArithmetic";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Do not add or subtract duration.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 3] = [b".days +", b".days -", b"duration_arithmetic"];
