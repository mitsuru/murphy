...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/EnvironmentVariableAccess";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Rails/EnvironmentVariableAccess violation";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 5] = [
        b"environment_variable_access",
        b"EnvironmentVariableAccess",
        b"environment",
        b"variable",
        b"access",
    ];
