...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/ReflectionClassName";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Use a string value for `class_name`.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 3] = [b"has_many", b"has_one", b"belongs_to"];
