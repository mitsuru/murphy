...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/OrderById";
pub(crate) const MESSAGE_BYTES: &[u8] =
    b"Do not use the `id` column for ordering. Use a timestamp column to order chronologically.";
