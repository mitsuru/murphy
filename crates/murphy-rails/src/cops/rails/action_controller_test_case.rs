...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/ActionControllerTestCase";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Use `ActionDispatch::IntegrationTest` instead.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 3] = [
        b"action_controller_test_case",
        b"ActionControllerTestCase",
        b"ActionController::TestCase",
    ];
