...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/FindByOrAssignmentMemoization";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Avoid memoizing `find_by` results with `||=`.";
