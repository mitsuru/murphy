...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/RedundantTravelBack";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Redundant `travel_back` detected.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 1] = [b"travel_back"];
