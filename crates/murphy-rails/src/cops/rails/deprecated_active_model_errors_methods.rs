...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/DeprecatedActiveModelErrorsMethods";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Avoid manipulating ActiveModel errors as hash directly.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 7] = [
        b"deprecated_active_model_errors_methods",
        b"DeprecatedActiveModelErrorsMethods",
        b"deprecated",
        b"active",
        b"model",
        b"errors",
