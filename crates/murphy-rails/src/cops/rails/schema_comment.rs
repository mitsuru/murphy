...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/SchemaComment";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Rails/SchemaComment violation";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 2] = [b"add_column", b"create_table"];
