...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/SafeNavigation";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Use safe navigation (`&.`) instead of `%<try>s`.";
