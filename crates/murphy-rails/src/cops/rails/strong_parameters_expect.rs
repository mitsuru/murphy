...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/StrongParametersExpect";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Use `%<prefer>s` instead.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 3] = [b"[]", b"require", b"permit"];
