...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/TimeZoneAssignment";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Use `Time.use_zone` with block instead of `Time.zone=`.";
