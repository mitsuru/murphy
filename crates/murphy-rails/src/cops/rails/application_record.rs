...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/ApplicationRecord";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Models should subclass `ApplicationRecord`.";
