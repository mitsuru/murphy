...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/MigrationClassName";
pub(crate) const MESSAGE_BYTES: &[u8] =
    b"Replace with `%<camelized_basename>s` that matches the file name.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 2] = [b"migration_class_name", b"MigrationClassName"];
