...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/SkipsModelValidations";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Avoid using `%<method>s` because it skips validations.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 5] = [
        b"skips_model_validations",
        b"SkipsModelValidations",
        b"skips",
        b"model",
        b"validations",
    ];
