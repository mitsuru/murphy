...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/NotNullColumn";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Do not add a NOT NULL column without a default value.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 2] = [b"add_column", b"add_reference"];
