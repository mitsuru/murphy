...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/Delegate";
pub(crate) const MESSAGE_BYTES: &[u8] = b"Use `delegate` to define delegations.";
...
pub(crate) unsafe extern "C" fn run(
    ...
    let patterns: [&[u8]; 2] = [b"delegate", b"Delegate"];
