...
pub(crate) const NAME_BYTES: &[u8] = b"Rails/DelegateAllowBlank";
pub(crate) const MESSAGE_BYTES: &[u8] = b"`allow_blank` is not a valid option, use `allow_nil`.";
